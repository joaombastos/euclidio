...
public:
	...
	// Permite que sequenciadores enfileirem Note On/Off diretamente de forma segura
	void enqueueNoteEvent(uint8_t channel, uint8_t note, uint8_t velocity, uint16_t noteLength, bool isNoteOn);
